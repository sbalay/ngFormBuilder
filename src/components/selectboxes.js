...
module.exports = function(app) {
    ...
    function(formioComponentsProvider) {
      formioComponentsProvider.register('selectboxes', {
        ...
        views: [
          ...
          {
            name: 'Data',
            template: 'formio/components/selectboxes/data.html'
          },
          {
            name: 'Validation',
  ...
  app.run([
    ...
    function($templateCache) {
      ...
      $templateCache.put('formio/components/selectboxes/data.html',
        '<ng-form>' +
          '<div class="form-group">' +
            '<label for="dataSrc" form-builder-tooltip="The source to use for the radio options. Values lets you provide your own values and labels. JSON lets you provide raw JSON data. URL lets you provide a URL to retrieve the JSON data from.">Data Source Type</label>' +
